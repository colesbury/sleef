...
#ifndef __SLEEFSIMDSP_H__
#define __SLEEFSIMDSP_H__
...
static INLINE CONST VECTOR_CC vint2 vilogbf(vfloat d) {
...
static INLINE CONST VECTOR_CC vfloat vldexpf(vfloat x, vint2 q) { return vldexp_vf_vf_vi2(x, q); }
...
static INLINE CONST VECTOR_CC vfloat vsinf(vfloat d) {
...
static INLINE CONST VECTOR_CC vfloat vcosf(vfloat d) {
#if !defined(DETERMINISTIC)
  vint2 q;
  vfloat u, s, r = d;
...
static INLINE CONST VECTOR_CC vfloat vtanf(vfloat d) {
#if !defined(DETERMINISTIC)
  vint2 q;
  vopmask o;
  vfloat u, s, x;
...
static INLINE CONST VECTOR_CC vfloat vsinf_u1(vfloat d) {
#if !defined(DETERMINISTIC)
  vint2 q;
  vfloat u, v;
  vfloat2 s, t, x;
...
static INLINE CONST VECTOR_CC vfloat vcosf_u1(vfloat d) {
#if !defined(DETERMINISTIC)
  vint2 q;
  vfloat u;
  vfloat2 s, t, x;
...
static INLINE CONST VECTOR_CC vfloat vfastsinf_u3500(vfloat d) {
  vint2 q;
  vfloat u, s, t = d;
  ...
  if (!LIKELY(vtestallones_i_vo32(g))) return vsel_vf_vo_vf_vf(g, u, vsinf(t));

  return u;
}

static INLINE CONST VECTOR_CC vfloat vfastcosf_u3500(vfloat d) {
  vint2 q;
  vfloat u, s, t = d;
  ...
  vopmask g = vlt_vo_vf_vf(vabs_vf_vf(t), vcast_vf_f(30.0f));
  if (!LIKELY(vtestallones_i_vo32(g))) return vsel_vf_vo_vf_vf(g, u, vcosf(t));

  return u;
}

static INLINE CONST VECTOR_CC vfloat2 vsincosf(vfloat d) {
#if !defined(DETERMINISTIC)
  vint2 q;
  vopmask o;
  vfloat u, s, t, rx, ry;
...
static INLINE CONST VECTOR_CC vfloat2 vsincosf_u1(vfloat d) {
#if !defined(DETERMINISTIC)
  vint2 q;
  vopmask o;
  vfloat u, v, rx, ry;
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat2 vsincospif_u05(vfloat d) {
  vopmask o;
  vfloat u, s, t, rx, ry;
  vfloat2 r, x, s2;
...
static INLINE CONST VECTOR_CC vfloat2 vsincospif_u35(vfloat d) {
  vopmask o;
  vfloat u, s, t, rx, ry;
  vfloat2 r;
...
static INLINE CONST VECTOR_CC vfloat2 vmodff(vfloat x) {
...
static INLINE CONST VECTOR_CC vfloat vtanf_u1(vfloat d) {
#if !defined(DETERMINISTIC)
  vint2 q;
  vfloat u, v;
  vfloat2 s, t, x;
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vatanf(vfloat d) {
  vfloat s, t, u;
  vint2 q;
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vatan2f(vfloat y, vfloat x) {
...
static INLINE CONST VECTOR_CC vfloat vasinf(vfloat d) {
...
static INLINE CONST VECTOR_CC vfloat vacosf(vfloat d) {
  vopmask o = vlt_vo_vf_vf(vabs_vf_vf(d), vcast_vf_f(0.5f));
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vatan2f_u1(vfloat y, vfloat x) {
...
static INLINE CONST VECTOR_CC vfloat vasinf_u1(vfloat d) {
  vopmask o = vlt_vo_vf_vf(vabs_vf_vf(d), vcast_vf_f(0.5f));
...
static INLINE CONST VECTOR_CC vfloat vacosf_u1(vfloat d) {
  vopmask o = vlt_vo_vf_vf(vabs_vf_vf(d), vcast_vf_f(0.5f));
  vfloat x2 = vsel_vf_vo_vf_vf(o, vmul_vf_vf_vf(d, d), vmul_vf_vf_vf(vsub_vf_vf_vf(vcast_vf_f(1), vabs_vf_vf(d)), vcast_vf_f(0.5f))), u;
  vfloat2 x = vsel_vf2_vo_vf2_vf2(o, vcast_vf2_vf_vf(vabs_vf_vf(d), vcast_vf_f(0)), dfsqrt_vf2_vf(x2));
  x = vsel_vf2_vo_vf2_vf2(veq_vo_vf_vf(vabs_vf_vf(d), vcast_vf_f(1.0f)), vcast_vf2_f_f(0, 0), x);
...
static INLINE CONST VECTOR_CC vfloat vatanf_u1(vfloat d) {
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vlogf(vfloat d) {
  vfloat x, x2, t, m;
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vexpf(vfloat d) {
...
#if defined(ENABLE_NEON32) || defined(ENABLE_NEON32VFPV4)
static INLINE CONST VECTOR_CC vfloat vsqrtf_u35(vfloat d) {
...
#else
static INLINE CONST VECTOR_CC vfloat vsqrtf_u35(vfloat d) { return vsqrt_vf_vf(d); }
#endif

#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vcbrtf(vfloat d) {
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vcbrtf_u1(vfloat d) {
  vfloat x, y, z, t;
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vlogf_u1(vfloat d) {
  vfloat2 x;
  vfloat t, m, x2;
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vpowf(vfloat x, vfloat y) {
#if 1
...
static INLINE CONST VECTOR_CC vfloat vfastpowf_u3500(vfloat x, vfloat y) {
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vsinhf(vfloat x) {
...
static INLINE CONST VECTOR_CC vfloat vcoshf(vfloat x) {
  vfloat y = vabs_vf_vf(x);
  vfloat2 d = expk2f(vcast_vf2_vf_vf(y, vcast_vf_f(0)));
...
static INLINE CONST VECTOR_CC vfloat vtanhf(vfloat x) {
  vfloat y = vabs_vf_vf(x);
  vfloat2 d = expk2f(vcast_vf2_vf_vf(y, vcast_vf_f(0)));
...
static INLINE CONST VECTOR_CC vfloat vsinhf_u35(vfloat x) {
...
static INLINE CONST VECTOR_CC vfloat vcoshf_u35(vfloat x) {
  vfloat e = vexpf(vabs_vf_vf(x));
...
static INLINE CONST VECTOR_CC vfloat vtanhf_u35(vfloat x) {
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vasinhf(vfloat x) {
  vfloat y = vabs_vf_vf(x);
...
static INLINE CONST VECTOR_CC vfloat vacoshf(vfloat x) {
...
static INLINE CONST VECTOR_CC vfloat vatanhf(vfloat x) {
  vfloat y = vabs_vf_vf(x);
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vexp2f(vfloat d) {
...
static INLINE CONST VECTOR_CC vfloat vexp2f_u35(vfloat d) {
  vfloat u = vrint_vf_vf(d), s;
  vint2 q = vrint_vi2_vf(u);
...
static INLINE CONST VECTOR_CC vfloat vexp10f(vfloat d) {
...
static INLINE CONST VECTOR_CC vfloat vexp10f_u35(vfloat d) {
  vfloat u = vrint_vf_vf(vmul_vf_vf_vf(d, vcast_vf_f(LOG10_2))), s;
  vint2 q = vrint_vi2_vf(u);
...
static INLINE CONST VECTOR_CC vfloat vexpm1f(vfloat a) {
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vlog10f(vfloat d) {
  vfloat2 x;
  vfloat t, m, x2;
...
static INLINE CONST VECTOR_CC vfloat vlog2f(vfloat d) {
  vfloat2 x;
  vfloat t, m, x2;
...
static INLINE CONST VECTOR_CC vfloat vlog2f_u35(vfloat d) {
  vfloat m, t, x, x2;
...
static INLINE CONST VECTOR_CC vfloat vlog1pf(vfloat d) {
  vfloat2 x;
  vfloat t, m, x2;
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vfabsf(vfloat x) { return vabs_vf_vf(x); }

static INLINE CONST VECTOR_CC vfloat vcopysignf(vfloat x, vfloat y) { return vcopysign_vf_vf_vf(x, y); }

static INLINE CONST VECTOR_CC vfloat vfmaxf(vfloat x, vfloat y) {
...
static INLINE CONST VECTOR_CC vfloat vfminf(vfloat x, vfloat y) {
#if (defined(__x86_64__) || defined(__i386__)) && !defined(ENABLE_VECEXT) && !defined(ENABLE_PUREC)
...
static INLINE CONST VECTOR_CC vfloat vfdimf(vfloat x, vfloat y) {
...
static INLINE CONST VECTOR_CC vfloat vtruncf(vfloat x) {
  vfloat fr = vsub_vf_vf_vf(x, vcast_vf_vi2(vtruncate_vi2_vf(x)));
...
static INLINE CONST VECTOR_CC vfloat vrintf(vfloat d) {
  vfloat x = vadd_vf_vf_vf(d, vcast_vf_f(0.5f));
...
static INLINE CONST VECTOR_CC vfloat vfmaf(vfloat x, vfloat y, vfloat z) {
...
static INLINE CONST VECTOR_CC vfloat vsqrtf_u05(vfloat d) {
  vfloat q;
  vopmask o;
...
static INLINE CONST VECTOR_CC vfloat vsqrtf(vfloat d) {
#ifdef ACCURATE_SQRT
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vhypotf_u05(vfloat x, vfloat y) {
  x = vabs_vf_vf(x);
  y = vabs_vf_vf(y);
...
static INLINE CONST VECTOR_CC vfloat vhypotf_u35(vfloat x, vfloat y) {
  x = vabs_vf_vf(x);
  y = vabs_vf_vf(y);
  vfloat min = vmin_vf_vf_vf(x, y), n = min;
  vfloat max = vmax_vf_vf_vf(x, y), d = max;
...
static INLINE CONST VECTOR_CC vfloat vnextafterf(vfloat x, vfloat y) {
...
static INLINE CONST VECTOR_CC vfloat vfrfrexpf(vfloat x) {
...
static INLINE CONST VECTOR_CC vint2 vexpfrexpf(vfloat x) {
  /*
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vfmodf(vfloat x, vfloat y) {
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vsinpif_u05(vfloat d) {
  vfloat2 x = sinpifk(d);
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vcospif_u05(vfloat d) {
  vfloat2 x = cospifk(d);
  vfloat r = vadd_vf_vf_vf(x.x, x.y);
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vfloat vtgammaf_u1(vfloat a) {
  df2 d = gammafk(a);
...
static INLINE CONST VECTOR_CC vfloat vlgammaf_u1(vfloat a) {
  df2 d = gammafk(a);
...
/* TODO AArch64: potential optimization by using `vfmad_lane_f64` */
static INLINE CONST VECTOR_CC vfloat verff_u1(vfloat a) {
  vfloat s = a, t, u;
  vfloat2 d;
...
/* TODO AArch64: potential optimization by using `vfmad_lane_f64` */
static INLINE CONST VECTOR_CC vfloat verfcf_u15(vfloat a) {
...
#endif // #ifndef __SLEEFSIMDSP_H__