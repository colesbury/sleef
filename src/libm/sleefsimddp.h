...
#ifndef __SLEEFSIMDDP_H__
#define __SLEEFSIMDDP_H__
...
static INLINE CONST VECTOR_CC vdouble vldexp(vdouble x, vint q) { return vldexp_vd_vd_vi(x, q); }

static INLINE CONST VECTOR_CC vint vilogb(vdouble d) {
...
static INLINE CONST VECTOR_CC vdouble vsin(vdouble d) {
...
static INLINE CONST VECTOR_CC vdouble vsin_u1(vdouble d) {
#if !defined(DETERMINISTIC)
  vdouble u;
  vdouble2 s, t, x;
  vint ql;
...
static INLINE CONST VECTOR_CC vdouble vcos(vdouble d) {
#if !defined(DETERMINISTIC)
  vdouble u, s, r = d;
  vint ql;
...
static INLINE CONST VECTOR_CC vdouble vcos_u1(vdouble d) {
#if !defined(DETERMINISTIC)
  vdouble u;
  vdouble2 s, t, x;
  vint ql;
...
static INLINE CONST VECTOR_CC vdouble2 vsincos(vdouble d) {
#if !defined(DETERMINISTIC)
  vopmask o;
  vdouble u, t, rx, ry, s;
  vdouble2 r;
...
static INLINE CONST VECTOR_CC vdouble2 vsincos_u1(vdouble d) {
#if !defined(DETERMINISTIC)
  vopmask o;
  vdouble u, rx, ry;
  vdouble2 r, s, t, x;
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vdouble2 vsincospi_u05(vdouble d) {
  vopmask o;
  vdouble u, s, t, rx, ry;
  vdouble2 r, x, s2;
...
static INLINE CONST VECTOR_CC vdouble2 vsincospi_u35(vdouble d) {
  vopmask o;
  vdouble u, s, t, rx, ry;
  vdouble2 r;
...
static INLINE CONST VECTOR_CC vdouble2 vmodf(vdouble x) {
...
static INLINE CONST VECTOR_CC vdouble vsinpi_u05(vdouble d) {
  vdouble2 x = sinpik(d);
...
static INLINE CONST VECTOR_CC vdouble vcospi_u05(vdouble d) {
  vdouble2 x = cospik(d);
  vdouble r = vadd_vd_vd_vd(x.x, x.y);
...
static INLINE CONST VECTOR_CC vdouble vtan(vdouble d) {
#if !defined(DETERMINISTIC)
  vdouble u, s, x, y;
  vopmask o;
  vint ql;
...
static INLINE CONST VECTOR_CC vdouble vtan_u1(vdouble d) {
#if !defined(DETERMINISTIC)
  vdouble u;
  vdouble2 s, t, x, y;
  vopmask o;
...
static INLINE CONST VECTOR_CC vdouble vatan2(vdouble y, vdouble x) {
...
static INLINE CONST VECTOR_CC vdouble vatan2_u1(vdouble y, vdouble x) {
...
static INLINE CONST VECTOR_CC vdouble vasin(vdouble d) {
...
static INLINE CONST VECTOR_CC vdouble vasin_u1(vdouble d) {
  vopmask o = vlt_vo_vd_vd(vabs_vd_vd(d), vcast_vd_d(0.5));
...
static INLINE CONST VECTOR_CC vdouble vacos(vdouble d) {
  vopmask o = vlt_vo_vd_vd(vabs_vd_vd(d), vcast_vd_d(0.5));
...
static INLINE CONST VECTOR_CC vdouble vacos_u1(vdouble d) {
  vopmask o = vlt_vo_vd_vd(vabs_vd_vd(d), vcast_vd_d(0.5));
  vdouble x2 = vsel_vd_vo_vd_vd(o, vmul_vd_vd_vd(d, d), vmul_vd_vd_vd(vsub_vd_vd_vd(vcast_vd_d(1), vabs_vd_vd(d)), vcast_vd_d(0.5))), u;
  vdouble2 x = vsel_vd2_vo_vd2_vd2(o, vcast_vd2_vd_vd(vabs_vd_vd(d), vcast_vd_d(0)), ddsqrt_vd2_vd(x2));
  x = vsel_vd2_vo_vd2_vd2(veq_vo_vd_vd(vabs_vd_vd(d), vcast_vd_d(1.0)), vcast_vd2_d_d(0, 0), x);
...
static INLINE CONST VECTOR_CC vdouble vatan_u1(vdouble d) {
...
static INLINE CONST VECTOR_CC vdouble vatan(vdouble s) {
  vdouble t, u;
  vint q;
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vdouble vlog(vdouble d) {
  vdouble x, x2;
  vdouble t, m;
...
static INLINE CONST VECTOR_CC vdouble vexp(vdouble d) {
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vdouble vlog_u1(vdouble d) {
  vdouble2 x;
  vdouble t, m, x2;
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vdouble vpow(vdouble x, vdouble y) {
#if 1
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vdouble vsinh(vdouble x) {
...
static INLINE CONST VECTOR_CC vdouble vcosh(vdouble x) {
  vdouble y = vabs_vd_vd(x);
  vdouble2 d = expk2(vcast_vd2_vd_vd(y, vcast_vd_d(0)));
...
static INLINE CONST VECTOR_CC vdouble vtanh(vdouble x) {
  vdouble y = vabs_vd_vd(x);
  vdouble2 d = expk2(vcast_vd2_vd_vd(y, vcast_vd_d(0)));
...
static INLINE CONST VECTOR_CC vdouble vsinh_u35(vdouble x) {
...
static INLINE CONST VECTOR_CC vdouble vcosh_u35(vdouble x) {
  vdouble e = vexp(vabs_vd_vd(x));
...
static INLINE CONST VECTOR_CC vdouble vtanh_u35(vdouble x) {
...
static INLINE CONST VECTOR_CC vdouble vasinh(vdouble x) {
  vdouble y = vabs_vd_vd(x);
...
static INLINE CONST VECTOR_CC vdouble vacosh(vdouble x) {
...
static INLINE CONST VECTOR_CC vdouble vatanh(vdouble x) {
  vdouble y = vabs_vd_vd(x);
...
static INLINE CONST VECTOR_CC vdouble vcbrt(vdouble d) {
...
static INLINE CONST VECTOR_CC vdouble vcbrt_u1(vdouble d) {
  vdouble x, y, z, t;
...
static INLINE CONST VECTOR_CC vdouble vexp2(vdouble d) {
...
static INLINE CONST VECTOR_CC vdouble vexp2_u35(vdouble d) {
  vdouble u = vrint_vd_vd(d), s;
  vint q = vrint_vi_vd(u);
...
static INLINE CONST VECTOR_CC vdouble vexp10(vdouble d) {
...
static INLINE CONST VECTOR_CC vdouble vexp10_u35(vdouble d) {
  vdouble u = vrint_vd_vd(vmul_vd_vd_vd(d, vcast_vd_d(LOG10_2))), s;
  vint q = vrint_vi_vd(u);
...
#if !defined(DETERMINISTIC)
static INLINE CONST VECTOR_CC vdouble vexpm1(vdouble a) {
...
static INLINE CONST VECTOR_CC vdouble vlog10(vdouble d) {
  vdouble2 x;
  vdouble t, m, x2;
...
static INLINE CONST VECTOR_CC vdouble vlog2(vdouble d) {
  vdouble2 x;
  vdouble t, m, x2;
...
static INLINE CONST VECTOR_CC vdouble vlog2_u35(vdouble d) {
  vdouble m, t, x, x2;
...
static INLINE CONST VECTOR_CC vdouble vlog1p(vdouble d) {
  vdouble2 x;
  vdouble t, m, x2;
...
static INLINE CONST VECTOR_CC vdouble vfabs(vdouble x) { return vabs_vd_vd(x); }

static INLINE CONST VECTOR_CC vdouble vcopysign(vdouble x, vdouble y) { return vcopysign_vd_vd_vd(x, y); }

static INLINE CONST VECTOR_CC vdouble vfmax(vdouble x, vdouble y) {
...
static INLINE CONST VECTOR_CC vdouble vfmin(vdouble x, vdouble y) {
#if (defined(__x86_64__) || defined(__i386__)) && !defined(ENABLE_VECEXT) && !defined(ENABLE_PUREC)
...
static INLINE CONST VECTOR_CC vdouble vfdim(vdouble x, vdouble y) {
...
static INLINE CONST VECTOR_CC vdouble vtrunc(vdouble x) {
  vdouble fr = vsub_vd_vd_vd(x, vmul_vd_vd_vd(vcast_vd_d(1LL << 31), vcast_vd_vi(vtruncate_vi_vd(vmul_vd_vd_vd(x, vcast_vd_d(1.0 / (1LL << 31)))))));
  fr = vsub_vd_vd_vd(fr, vcast_vd_vi(vtruncate_vi_vd(fr)));
...
static INLINE CONST VECTOR_CC vdouble vfloor(vdouble x) {
  vdouble fr = vsub_vd_vd_vd(x, vmul_vd_vd_vd(vcast_vd_d(1LL << 31), vcast_vd_vi(vtruncate_vi_vd(vmul_vd_vd_vd(x, vcast_vd_d(1.0 / (1LL << 31)))))));
  fr = vsub_vd_vd_vd(fr, vcast_vd_vi(vtruncate_vi_vd(fr)));
...
static INLINE CONST VECTOR_CC vdouble vceil(vdouble x) {
  vdouble fr = vsub_vd_vd_vd(x, vmul_vd_vd_vd(vcast_vd_d(1LL << 31), vcast_vd_vi(vtruncate_vi_vd(vmul_vd_vd_vd(x, vcast_vd_d(1.0 / (1LL << 31)))))));
  fr = vsub_vd_vd_vd(fr, vcast_vd_vi(vtruncate_vi_vd(fr)));
...
static INLINE CONST VECTOR_CC vdouble vround(vdouble d) {
...
static INLINE CONST VECTOR_CC vdouble vrint(vdouble d) {
  vdouble x = vadd_vd_vd_vd(d, vcast_vd_d(0.5));
  vdouble fr = vsub_vd_vd_vd(x, vmul_vd_vd_vd(vcast_vd_d(1LL << 31), vcast_vd_vi(vtruncate_vi_vd(vmul_vd_vd_vd(x, vcast_vd_d(1.0 / (1LL << 31)))))));
...
static INLINE CONST VECTOR_CC vdouble vnextafter(vdouble x, vdouble y) {
...
static INLINE CONST VECTOR_CC vdouble vfrfrexp(vdouble x) {
...
static INLINE CONST VECTOR_CC vint vexpfrexp(vdouble x) {
  x = vsel_vd_vo_vd_vd(vlt_vo_vd_vd(vabs_vd_vd(x), vcast_vd_d(DBL_MIN)), vmul_vd_vd_vd(x, vcast_vd_d(1ULL << 63)), x);
...
static INLINE CONST VECTOR_CC vdouble vfma(vdouble x, vdouble y, vdouble z) {
...
static INLINE CONST VECTOR_CC vdouble vsqrt_u05(vdouble d) {
  vdouble q;
  vopmask o;
...
static INLINE CONST VECTOR_CC vdouble vsqrt(vdouble d) {
#ifdef ACCURATE_SQRT
...
static INLINE CONST VECTOR_CC vdouble vsqrt_u35(vdouble d) { return vsqrt_u05(d); }

static INLINE CONST VECTOR_CC vdouble vhypot_u05(vdouble x, vdouble y) {
  x = vabs_vd_vd(x);
  y = vabs_vd_vd(y);
...
static INLINE CONST VECTOR_CC vdouble vhypot_u35(vdouble x, vdouble y) {
  x = vabs_vd_vd(x);
  y = vabs_vd_vd(y);
...
static INLINE CONST VECTOR_CC vdouble vfmod(vdouble x, vdouble y) {
...
static INLINE CONST VECTOR_CC vdouble vtgamma_u1(vdouble a) {
  dd2 d = gammak(a);
...
static INLINE CONST VECTOR_CC vdouble vlgamma_u1(vdouble a) {
  dd2 d = gammak(a);
...
/* TODO AArch64: potential optimization by using `vfmad_lane_f64` */
static INLINE CONST VECTOR_CC vdouble verf_u1(vdouble a) {
  vdouble s = a, t, u;
  vdouble2 d;
...
/* TODO AArch64: potential optimization by using `vfmad_lane_f64` */
static INLINE CONST VECTOR_CC vdouble verfc_u15(vdouble a) {
...
#endif // #ifndef __SLEEFSIMDDP_H__